...
public class AddRacquetActivity extends AppCompatActivity {
    AddRacquetPresenter mAddRacquetPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddRacquetPresenter = new AddRacquetPresenter();

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
        TextView titleView = toolbar.findViewById(R.id.toolbar_title);
        titleView.setText(R.string.add_racquet);
        ...
        saveButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        id = UUID.randomUUID();
                        Racquet r = new Racquet(id, date, clientName, stringBrand, stringType, tension, tensionUnit, quantity, notes);
                        mAddRacquetPresenter.addRacquet(r);
    ...
    public void showDatePickerDialog(View v) {
        ...
        // date picker dialog
        datePicker = new DatePickerDialog(AddRacquetActivity.this,
